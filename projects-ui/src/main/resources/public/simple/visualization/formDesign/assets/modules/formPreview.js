        ...
        Class.prototype.components = {
            ...
            password: {
                ...
                render: function (json, selected) {
                    ...
                    _html += '<label class="layui-form-label {0}">{1}:</label>'.format(json.required ? 'layui-form-required' : '', json.label);
                    _html += '<div class="layui-input-block">';
                    _html += '<input type="password" name="{0}" lay-verify="pass" placeholder="{1}" value="{2}" autocomplete="off" style="width:{3}" {4} {5} {6} class="layui-input">'
                    .format(json.id,json.defaultValue ? json.defaultValue : '', json.width,json.placeholder,_readonly,_disabled,_required);
                    _html += '</div>';
                    _html += '</div>';
                    return _html;
            ...
            select: {
                ...
                render: function (json, selected) {
                    ...
                    _html += '<select name="{0}" lay-verify="required" style="width:{1}">'.format(json.id, json.width);
            ...
            switch: {
                ...
                render: function (json, selected) {
                    ...
                    _html += '<input type="checkbox" name="{0}" lay-skin="switch" lay-text="ON|OFF">'.format(json.tag);
                    _html += '</div>';
                    _html += '</div>';
                    return _html;
                },
            ...
            textarea: {
                ...
                render: function (json, selected) {
                    ...
                    _html += '<label class="layui-form-label {0}">{1}:</label>'.format(json.required ? 'layui-form-required' : '', json.label);
                    _html += '<div class="layui-input-block">';
                    _html += '<textarea name="{0}" placeholder="{3}" width="{2}" class="layui-textarea" {4} {5} {6}>{1}</textarea>'
                    .format(json.id,json.defaultValue ? json.defaultValue : '', json.width,json.placeholder,_readonly,_disabled,_required);
                    _html += '</div>';
                    // if(selected){
                    // 	_html +='<div class="widget-view-action"><i class="layui-icon layui-icon-file"></i><i class="layui-icon layui-icon-delete"></i></div><div class="widget-view-drag"><i class="layui-icon layui-icon-screen-full"></i></div>';
         ...
         Class.prototype.render = function () {
            ...
            options.elem.html('<form  class="layui-form" style="height:100%;" id="formPreviewForm"></form>'); 
            that.renderForm();
