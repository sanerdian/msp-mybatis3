...
const columns = [
	...
	,{field:'', title: '操作',fixed: 'right',toolbar: '#operateTemplate',align: 'left',width:170}
];
// 弹出的新增/修改界面的窗体的高度
...
function init() {
	...
	$('.layui-btn').click(function(){
		...
		if(type === 'add'){
			...
			exportExcel(service_prefix.gateway,uriRoot+"/downloadExcel","signature.xls",param4Data,columns);
		}
