...
const columns = [
	...
	,{field:'value', title: '阈值(每分钟)', align: 'right',sort: true,width:120}
	,{field:'remark', title: '备注', align: 'left',sort: true}
	,{field:'lastUsedTime', title: '上次警告生成时间', align: 'left',sort: true,width:200}
	,{field:'', title: '操作',fixed: 'right',toolbar: '#operateTemplate',align: 'left',width:120}
];
// 弹出的新增/修改界面的窗体的高度
const height4OpenData='350px';
...
function init() {
	...
	$('.layui-btn').click(function(){
		...
		if(type === 'add'){
            ...
            exportExcel(service_prefix.gateway,uriRoot+"/downloadExcel","alarmRule.xls",param4Data,columns);
        }
