...
//             elem : '#upload1', //绑定元素
//             url : 'resources/picture/upload', //上传接口
...
//                     $("#upload_preview").append("<img alt='预览图' src='"+ "/resources/picture/downLoad?id="+res.id +"' width='230px' height='146px' />");
//                     $("#counts").text($("#upload_preview").children().length)
//                 }
//                 //获取当前触发上传的元素
//                 //var item = this.item;
//             },
