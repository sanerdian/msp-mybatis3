...
function taskList(current){
    ajax(service_prefix.flowable,"/taskList","post",JSON.stringify({entity:{},pager:{current:current,size:15}})).then(res => {
...
function historyList(current){
    ajax(service_prefix.flowable,"/historyList","post",JSON.stringify({entity:{},pager:{current:current,size:15}})).then(res => {
...
function procList(current) {
    ajax(service_prefix.flowable,"/procList","post",JSON.stringify({entity:{},pager:{current:current,size:15}})).then(res => {
