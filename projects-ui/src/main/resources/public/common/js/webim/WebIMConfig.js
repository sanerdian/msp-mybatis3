...
function getUrl(){
    ...
    if(window.location.href.indexOf("webim-h5.easemob.com") !== -1 || window.location.href.indexOf("localhost") !== -1 || window.location.href.indexOf("192.168.1.183") !== -1){
...
var config = {
     ...
     * Application AppKey
     */
    appkey: "1109191209065878#xazqfwplatform",
    /*
     * Application Host
     */
    Host: "easemob.com",
