 ...
 */
@Component
public class SignListener implements ExecutionListener, ApplicationContextAware {
    ...
    public void notify(DelegateExecution execution) {
        ...
        listenerService.updateWhenStartNode(execution.getProcessInstanceId(), NewsStatus.SIGN.getCode());
    }
}
