 ...
 */
@Component
public class AuditListener implements ExecutionListener, ApplicationContextAware {
    ...
    public void notify(DelegateExecution execution) {
        ...
        listenerService.updateWhenStartNode(execution.getProcessInstanceId(), NewsStatus.AUDIT.getCode());
    }
}
