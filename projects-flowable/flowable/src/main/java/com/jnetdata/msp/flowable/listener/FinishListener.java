 ...
 */
@Component
public class FinishListener implements ExecutionListener, ApplicationContextAware {
    ...
    public void notify(DelegateExecution execution) {
        ...
        listenerService.updateForEnd(execution.getProcessInstanceId(), AuditStatus.FINISHED.getCode());
    }
}
