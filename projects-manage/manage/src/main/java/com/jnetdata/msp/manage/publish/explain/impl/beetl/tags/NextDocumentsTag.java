...
import com.jnetdata.msp.manage.publish.explain.impl.beetl.tags.attr.NextDocumentsTagAttr;
...
@Service
@Scope("prototype")
@BeetlTagName(TagsConstant.JNET_NEXTDOCUMENTS)
public class NextDocumentsTag extends GeneralTag<NextDocumentsTagAttr> {
    @Override
    public void render() {
    ...
    public String getName() {
        return TagsConstant.JNET_NEXTDOCUMENTS;
    }
