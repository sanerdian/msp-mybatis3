package com.jnetdata.msp.exercise.computer.model;
...
@TableName("jmeta_computer")
@ApiModel(value = "Computer对象", description = "练习")
public class Computer extends BaseEntity implements EntityId<Long>  {

    private static final long serialVersionUID=1L;

    @ExcelProperty(value = "电脑编号")
    @ApiModelProperty(value = "电脑编号")
    @TableField("COMPUTER_CODE")
    private String computerCode;
    @ExcelProperty(value = "使用员工名称")
    @ApiModelProperty(value = "使用员工名称")
    ...
    @ExcelProperty(value = "请问")
    @ApiModelProperty(value = "请问")
    @TableField("QWE")
    private String qwe;
