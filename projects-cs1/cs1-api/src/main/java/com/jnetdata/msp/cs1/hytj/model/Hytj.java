package com.jnetdata.msp.cs1.hytj.model;
...
@TableName("jmeta_hytj")
@ApiModel(value = "Hytj对象", description = "")
public class Hytj extends BaseEntity implements EntityId<Long>  {

    private static final long serialVersionUID=1L;


    @ExcelProperty(value = "HYID")
    @ApiModelProperty(value = "HYID")
    @TableField("HYID")
    private String hyid;
    @ExcelProperty(value = "HYMC")
    @ApiModelProperty(value = "HYMC")
    @TableField("HYMC")
    private String hymc;
    @ExcelProperty(value = "FZRY")
    @ApiModelProperty(value = "FZRY")
    @TableField("FZRY")
    private String fzry;
    @ExcelProperty(value = "YT")
    @ApiModelProperty(value = "YT")
    @TableField("YT")
    private String yt;
    @ExcelProperty(value = "JB")
    @ApiModelProperty(value = "JB")
    @TableField("JB")
    private String jb;
