package com.jnetdata.msp.cs1.test_test1_test2.model;
...
@TableName("jmeta_test_test1_test2")
@ApiModel(value = "TestTest1Test2对象", description = "TEST_TEST1_TEST2")
public class TestTest1Test2 extends BaseEntity implements EntityId<Long>  {
