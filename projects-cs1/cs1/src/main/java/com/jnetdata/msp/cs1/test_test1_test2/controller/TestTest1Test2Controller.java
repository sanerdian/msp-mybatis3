package com.jnetdata.msp.cs1.test_test1_test2.controller;
 ...
 */
@Controller
@RequestMapping("/cs1/testtest1test2")
public class TestTest1Test2Controller extends BaseController<Long,TestTest1Test2> {

    final private TestTest1Test2Service testTest1Test2Service;
    ...
    @Autowired
    public TestTest1Test2Controller(TestTest1Test2Service testTest1Test2Service) {
        this.testTest1Test2Service = testTest1Test2Service;
    }
    ...
    @PostMapping
    @ResponseBody
    public JsonResult<EntityId<Long>> add(@Validated @RequestBody TestTest1Test2 entity) {
    ...
    public void syncAdd(Long columnid,Long fromid){
        TestTest1Test2 toCopy = new TestTest1Test2();
        toCopy.setSingletempkate(0L);
        toCopy.setCopyfromid(fromid);

        TestTest1Test2 toYinyong = new TestTest1Test2();
    ...
    @PostMapping("/batch")
    @ResponseBody
    public JsonResult addbatch( @RequestBody List<TestTest1Test2> list) {
    ...
    @GetMapping("/{id}")
    @ResponseBody
    public JsonResult<TestTest1Test2> getById(@PathVariable("id") Long id) {
    ...
    @GetMapping("/pub/{id}")
    @ResponseBody
    public JsonResult<TestTest1Test2> pub(@PathVariable("id") Long id) {
        pubData(id);
        return renderSuccess();
    }
    ...
    @PostMapping("/pub")
    @ResponseBody
    public JsonResult<TestTest1Test2> pubByIds(@RequestBody Long[] ids) {
        for (Long id : ids) {
            pubData(id);
        }
        return renderSuccess();
    ...
    @GetMapping("/repub/{id}")
    @ResponseBody
    public JsonResult<TestTest1Test2> repub(@PathVariable("id") Long id) {
        repubData(id);
        return renderSuccess();
    }
    ...
    @PostMapping("/repub")
    @ResponseBody
    public JsonResult<TestTest1Test2> repubByIds(@RequestBody Long[] ids) {
        for (Long id : ids) {
            repubData(id);
        }
        return renderSuccess();
    ...
    @GetMapping("/pass/{id}")
    @ResponseBody
    public JsonResult<TestTest1Test2> pass(@PathVariable("id") Long id,String content) {
        passData(id,content);
        return renderSuccess();
    }
    ...
    @PostMapping("/pass")
    @ResponseBody
    public JsonResult<TestTest1Test2> passByIds(@RequestBody Long[] ids,String content) {
        for (Long id : ids) {
            passData(id,content);
        }
        return renderSuccess();
    ...
    @ResponseBody
    public JsonResult<TestTest1Test2> notpass(@PathVariable("id") Long id,String content) {
    ...
    @PostMapping("/notpass")
    @ResponseBody
    public JsonResult<TestTest1Test2> notpassByIds(@RequestBody Long[] ids,String content) {
        for (Long id : ids) {
            notpassData(id,content);
        }
        return renderSuccess();
    ...
    public void passData(Long id,String content){
        TestTest1Test2 res = getService().getById(id);
        res.setStatus(10);
    ...
    public void pubData(Long id){
        ...
        if(!tocopycolumnId.isEmpty()){
            List<TestTest1Test2> toSyncEdit = getService().list(new PropertyWrapper<>(TestTest1Test2.class).eq("copyfromid", id).in("columnid", tocopycolumnId));
            if(!toSyncEdit.isEmpty()){
                for (TestTest1Test2 sync : toSyncEdit) {
    ...
    public JsonResult<Void> deleteByIdGet(@PathVariable("id") Long id) {
        ...
        TestTest1Test2 entity = new TestTest1Test2();
        entity.setId(id);
    ...
    public JsonResult<Void> deleteBatchIdsGet(@PathVariable("ids") String ids) {
        ...
        //删除已发布的
        List<TestTest1Test2> entitys = getService().listByIds(Arrays.asList(idss));
        ...
        List<TestTest1Test2> toDel = new ArrayList<>();
        for (String s : idss) {
            TestTest1Test2 entity = new TestTest1Test2();
    ...
    public JsonResult<Void> deleteBatchIds(@RequestBody Long[] ids) {
        //删除已发布的
        List<TestTest1Test2> entitys = getService().listByIds(Arrays.asList(ids));
        List<Long> delIds = entitys.stream().filter(m -> m.getDocchannelid() != null).map(m -> m.getDocchannelid()).collect(Collectors.toList());
        getService().deleteBatchIds(delIds);
    ...
    public JsonResult<Void> batchdelIdsGet(@PathVariable("ids") String ids,@PathVariable("columnid") Long columnid) {
        ...
        //删除同步的
        List<TestTest1Test2> delSync = new ArrayList<>();
        for (TestTest1Test2 entity : entitys) {
    ...
    */
    ...
    public void delSync(Long columnid,List<TestTest1Test2> entitys) {
        for (TestTest1Test2 entity : entitys) {
    ...
    @PostMapping("/{id}")
    @ResponseBody
    public JsonResult<Void> updateByIdPost(@PathVariable("id") Long id, @RequestBody TestTest1Test2 entity) {
        List<Fenfa> fenfas = fenfaService.list(new PropertyWrapper<>(Fenfa.class)
        ...
        if(targetColumnIds.size() > 0){
            List<TestTest1Test2> syncs = getService().list(new PropertyWrapper<>(TestTest1Test2.class).in("columnid", targetColumnIds).eq("copyfromid", id));
            if(syncs.size() > 0) {
                for (TestTest1Test2 sync : syncs) {
                    Long syncId = sync.getId();
                    Long columnId = sync.getColumnid();
    ...
    @PutMapping("/{id}")
    @ResponseBody
    public JsonResult<Void> updateById(@PathVariable("id") Long id, @RequestBody TestTest1Test2 entity) {
        List<Fenfa> fenfas = fenfaService.list(new PropertyWrapper<>(Fenfa.class)
            .like("fromids", entity.getColumnid() + "%")
            .eq("synctype", 0)
            .like("syncwhile", "1"));
    ...
    @ResponseBody
    public JsonResult<Void> batchUpdatePost(@RequestBody List<TestTest1Test2> list) {
    ...
    @ResponseBody
    public JsonResult<Void> batchUpdate(@RequestBody List<TestTest1Test2> list) {
        getService().updateBatchById(list);
        return renderSuccess();
    }
    ...
    public JsonResult<Void> updateBatchById(@RequestBody Long[] ids, Integer docstatus) {
        List<TestTest1Test2> list = new ArrayList<>();
        for (Long id : ids) {
            TestTest1Test2 entity = new TestTest1Test2();
            entity.setId(id);
    ...
    @ResponseBody
    public JsonResult<Void> doUpdateAllColumnByIdPost(@PathVariable("id") Long id, @RequestBody TestTest1Test2 entity) {
    ...
    @ResponseBody
    public JsonResult<Void> doUpdateAllColumnById(@PathVariable("id") Long id, @RequestBody TestTest1Test2 entity) {
        return doUpdateAllColumnById(getService(), id, entity);
    }
    ...
    @GetMapping("/{id}/join")
    @ResponseBody
    public JsonResult<TestTest1Test2> getjoin(@PathVariable("id") Long id) {
        TestTest1Test2 entity = getService().getEntityAndJoinsById(id);
    ...
    @ResponseBody
    public JsonResult<Pager<TestTest1Test2>> listjoin(@RequestBody BaseVo<TestTest1Test2> vo) {
        JsonResult<Pager<TestTest1Test2>> pagerJsonResult = doList(getService(), vo.getPager(), vo.getEntity());
        List<TestTest1Test2> list = pagerJsonResult.getObj().getRecords();
    ...
    public JsonResult importData(String columnid, MultipartFile file) throws Exception {
        ...
        List<Fieldinfo> list = fieldinfoUtilService.list(new PropertyWrapper<>(Fieldinfo.class).eq("tablename", "jmeta_test_test1_test2"));
        ...
        List<TestTest1Test2> list2 = new ArrayList<>();
        list1.forEach(item -> {
            TestTest1Test2 obj = MapUtil.map2Obj(item, TestTest1Test2.class);
    ...
    @ResponseBody
    public JsonResult<Pager<TestTest1Test2>> list(@ModelAttribute TestTest1Test2 entity,@RequestBody PageVo1 pager) {
    ...
    @ResponseBody
    public JsonResult<Pager<TestTest1Test2>> list(@RequestBody BaseVo<TestTest1Test2> vo) {
        if(vo.getEntity() == null) vo.setEntity(new TestTest1Test2());
            vo.getEntity().setDocstatus(0);
            JsonResult<Pager<TestTest1Test2>> result = doList(getService(), vo.getPager(), vo.getEntity());
            for (TestTest1Test2 record : result.getObj().getRecords()) {
    ...
    @ResponseBody
    public JsonResult<Pager<TestTest1Test2>> delListing(@RequestBody BaseVo<TestTest1Test2> vo) {
        if(vo.getEntity() == null) vo.setEntity(new TestTest1Test2());
    ...
    @ResponseBody
    public JsonResult<Pager<TestTest1Test2>> pubListing(@RequestBody BaseVo<TestTest1Test2> vo) {
                if(vo.getEntity() == null) vo.setEntity(new TestTest1Test2());
        List<TestTest1Test2> list = getService().list(new PropertyWrapper<>(TestTest1Test2.class).eq("status", "21").eq("docstatus", 0).select("docchannelid"));
    ...
    public void export(TestTest1Test2 entity, ExportVo vo, HttpServletResponse response) {
        List<TestTest1Test2> datalist;
        if(vo.getArea() == 2){
            datalist = getService().list();
        }else{
            datalist = getService().list(createCondition(entity));
        }
        List<Fieldinfo> list = fieldinfoUtilService.list(new PropertyWrapper<>(Fieldinfo.class).eq("tablename", "jmeta_test_test1_test2").eq("showList", 1));
        DownMetadataUtil.downMetadata(list,datalist,response,vo.getExt(),vo.getIncludeTitle(),TestTest1Test2.class);
    }

    @ApiOperation(value = "导出", notes="根据vo指定条件进行导出")
    @PostMapping(value = "/export2")
    public void export2(@RequestBody ExportVo<TestTest1Test2> vo, HttpServletResponse response) {
        List<TestTest1Test2> datalist;
        if(vo.getArea() == 2){
            datalist = getService().list();
        }else{
    ...
    public void export3(ExportVo<TestTest1Test2> vo, HttpServletResponse response) {
        List<TestTest1Test2> datalist;
        if(vo.getArea() == 2){
            datalist = getService().list();
        }else{
        ...
        if(vo.getFields() != null){
            DownMetadataUtil.downMetadata(datalist,response,vo.getExt(),vo.getIncludeTitle(),TestTest1Test2.class,vo.getFields());
        }else{
            List<Fieldinfo> list = fieldinfoUtilService.list(new PropertyWrapper<>(Fieldinfo.class).eq("tablename","jmeta_test_test1_test2").eq("showList", 1));
            DownMetadataUtil.downMetadata(list,datalist,response,vo.getExt(),vo.getIncludeTitle(),TestTest1Test2.class);
        }
    ...
    private TestTest1Test2Service getService() {
        return this.testTest1Test2Service;
    }
