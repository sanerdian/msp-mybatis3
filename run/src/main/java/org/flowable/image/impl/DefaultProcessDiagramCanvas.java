...
public class DefaultProcessDiagramCanvas {
    ...
    public void initialize(String imageType) {
        ...
        LABEL_FONT = FontUtil.getFont();
        ANNOTATION_FONT  = FontUtil.getFont();
        ...
        try {
            ...
            CONDITIONAL_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResource("org/flowable/icons/conditional.png", this.customClassLoader));
            ...
            ESCALATION_THROW_IMAGE = ImageIO.read(ReflectUtil.getResource("org/flowable/icons/escalation-throw.png", this.customClassLoader));
            ESCALATION_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResource("org/flowable/icons/escalation.png", this.customClassLoader));
    ...
    public InputStream generateImage(String imageType) {
        if (this.closed) {
            ...
            try {
                ...
                throw new FlowableImageException("Error while generating process image", var11);
            } finally {
                try {
                    if (out != null) {
                        out.close();
    ...
    public void drawStartEvent(GraphicInfo graphicInfo, BufferedImage image, double scaleFactor) {
        ...
        if (image != null) {
            int imageX = (int)Math.round(graphicInfo.getX() + graphicInfo.getWidth() / 2.0D - (double)image.getWidth() / (2.0D * scaleFactor));
            int imageY = (int)Math.round(graphicInfo.getY() + graphicInfo.getHeight() / 2.0D - (double)image.getHeight() / (2.0D * scaleFactor));
    ...
    public void drawEscalationEndEvent(String name, GraphicInfo graphicInfo, double scaleFactor) {
        this.drawEscalationEndEvent(graphicInfo, scaleFactor);
        if (scaleFactor == 1.0D) {
            this.drawLabel(name, graphicInfo);
        }
    ...
    public void drawEscalationEndEvent(GraphicInfo graphicInfo, double scaleFactor) {
        this.drawNoneEndEvent(graphicInfo, scaleFactor);
        this.g.drawImage(ESCALATION_THROW_IMAGE, (int)(graphicInfo.getX() + graphicInfo.getWidth() / 4.0D), (int)(graphicInfo.getY() + graphicInfo.getHeight() / 4.0D), (int)((double)ESCALATION_THROW_IMAGE.getWidth() / scaleFactor), (int)((double)ESCALATION_THROW_IMAGE.getHeight() / scaleFactor), (ImageObserver)null);
    }
    ...
    public void drawEscalationStartEvent(GraphicInfo graphicInfo, double scaleFactor) {
        this.drawNoneStartEvent(graphicInfo);
        this.g.drawImage(ESCALATION_CATCH_IMAGE, (int)(graphicInfo.getX() + graphicInfo.getWidth() / 4.0D), (int)(graphicInfo.getY() + graphicInfo.getHeight() / 4.0D), (int)((double)ESCALATION_CATCH_IMAGE.getWidth() / scaleFactor), (int)((double)ESCALATION_CATCH_IMAGE.getHeight() / scaleFactor), (ImageObserver)null);
    }

    public void drawConditionalStartEvent(GraphicInfo graphicInfo, double scaleFactor) {
        this.drawNoneStartEvent(graphicInfo);
        this.g.drawImage(CONDITIONAL_CATCH_IMAGE, (int)(graphicInfo.getX() + graphicInfo.getWidth() / 4.0D), (int)(graphicInfo.getY() + graphicInfo.getHeight() / 4.0D), (int)((double)CONDITIONAL_CATCH_IMAGE.getWidth() / scaleFactor), (int)((double)CONDITIONAL_CATCH_IMAGE.getHeight() / scaleFactor), (ImageObserver)null);
    }
    ...
    public void drawCatchingEvent(GraphicInfo graphicInfo, boolean isInterrupting, BufferedImage image, String eventType, double scaleFactor) {
        ...
        int innerCircleSize = (int)(2.0D / scaleFactor);
        ...
        if (image != null) {
            int imageX = (int)(graphicInfo.getX() + graphicInfo.getWidth() / 2.0D - (double)image.getWidth() / (2.0D * scaleFactor));
            int imageY = (int)(graphicInfo.getY() + graphicInfo.getHeight() / 2.0D - (double)image.getHeight() / (2.0D * scaleFactor));
    ...
    public void drawCatchingConditionalEvent(String name, GraphicInfo graphicInfo, boolean isInterrupting, double scaleFactor) {
        this.drawCatchingConditionalEvent(graphicInfo, isInterrupting, scaleFactor);
        this.drawLabel(name, graphicInfo);
    }

    public void drawCatchingConditionalEvent(GraphicInfo graphicInfo, boolean isInterrupting, double scaleFactor) {
        this.drawCatchingEvent(graphicInfo, isInterrupting, CONDITIONAL_CATCH_IMAGE, "conditional", scaleFactor);
    }
    ...
    public void drawCatchingEscalationEvent(GraphicInfo graphicInfo, boolean isInterrupting, double scaleFactor) {
        this.drawCatchingEvent(graphicInfo, isInterrupting, ESCALATION_CATCH_IMAGE, "escalation", scaleFactor);
    }
    ...
    public void drawThrowingEscalationEvent(GraphicInfo graphicInfo, double scaleFactor) {
        this.drawCatchingEvent(graphicInfo, true, ESCALATION_THROW_IMAGE, "escalation", scaleFactor);
    }
    ...
    public void drawTask(BufferedImage icon, String name, GraphicInfo graphicInfo, double scaleFactor) {
        this.drawTask(name, graphicInfo, scaleFactor);
    ...
    public void drawTask(String name, GraphicInfo graphicInfo, double scaleFactor) {
        this.drawTask(name, graphicInfo, false, scaleFactor);
    }
    ...
    public void drawPoolOrLane(String name, GraphicInfo graphicInfo, double scaleFactor) {
        ...
        if (scaleFactor == 1.0D && name != null && name.length() > 0) {
    ...
    protected void drawMultilineText(String text, int x, int y, int boxWidth, int boxHeight, boolean centered) {
        ...
        float currentY = (float)(y + (centered ? (boxHeight - currentHeight) / 2 : 0));
        float currentX = 0.0F;

        TextLayout textLayout;
        for(Iterator var16 = layouts.iterator(); var16.hasNext(); currentY += textLayout.getDescent() + textLayout.getLeading()) {
            textLayout = (TextLayout)var16.next();
            currentY += textLayout.getAscent();
            currentX = (float)x + (centered ? ((float)boxWidth - java.lang.Double.valueOf(textLayout.getBounds().getWidth()).floatValue()) / 2.0F : 0.0F);
    ...
    public void drawShellTask(String name, GraphicInfo graphicInfo, double scaleFactor) {
        this.drawTask(SHELL_TASK_IMAGE, name, graphicInfo, scaleFactor);
    }

    public void drawDMNTask(String name, GraphicInfo graphicInfo, double scaleFactor) {
        this.drawTask(DMN_TASK_IMAGE, name, graphicInfo, scaleFactor);
    }
    ...
    public void drawHttpTask(String name, GraphicInfo graphicInfo, double scaleFactor) {
        this.drawTask(HTTP_TASK_IMAGE, name, graphicInfo, scaleFactor);
    }
    ...
    public void drawLabel(String text, GraphicInfo graphicInfo, boolean centered) {
        ...
        if (text != null && text.length() > 0) {
            ...
            TextLayout tl;
            for(LineBreakMeasurer lbm = new LineBreakMeasurer(aci, frc); lbm.getPosition() < text.length(); textY += (double)(tl.getDescent() + tl.getLeading() + (interline - 1.0F) * tl.getAscent())) {
                tl = lbm.nextLayout((float)wrapWidth);
                textY += (double)tl.getAscent();
    ...
    private static Shape createShape(DefaultProcessDiagramCanvas.SHAPE_TYPE shapeType, GraphicInfo graphicInfo) {
        if (DefaultProcessDiagramCanvas.SHAPE_TYPE.Rectangle == shapeType) {
            return new java.awt.geom.Rectangle2D.Double(graphicInfo.getX(), graphicInfo.getY(), graphicInfo.getWidth(), graphicInfo.getHeight());
        } else if (DefaultProcessDiagramCanvas.SHAPE_TYPE.Rhombus == shapeType) {
            ...
            return DefaultProcessDiagramCanvas.SHAPE_TYPE.Ellipse == shapeType ? new Double(graphicInfo.getX(), graphicInfo.getY(), graphicInfo.getWidth(), graphicInfo.getHeight()) : null;
        }
    }
