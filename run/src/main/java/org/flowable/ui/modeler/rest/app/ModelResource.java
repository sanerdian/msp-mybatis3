...
public class ModelResource {
    ...
    public JSONObject getModelJSON(@PathVariable String modelId) {
        Model model = this.modelService.getModel(modelId);
        ObjectNode modelNodeTemp = this.objectMapper.createObjectNode();
        JSONObject modelNode = JSON.parseObject(modelNodeTemp.toString());
        modelNode.put("modelId", model.getId());
        modelNode.put("name", model.getName());
        modelNode.put("key", model.getKey());
        modelNode.put("description", model.getDescription());
        modelNode.put("lastUpdated", model.getLastUpdated());
        ...
        if (StringUtils.isNotEmpty(model.getModelEditorJson())) {
            try {
                ...
                modelNode.put("model", JSON.parseObject(editorJsonNode.toString()));
