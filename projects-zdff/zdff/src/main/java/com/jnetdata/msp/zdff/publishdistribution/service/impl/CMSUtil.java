...
public  class CMSUtil {
	 ...
	 * @author wangxuetao
	 * @return int
	 * 通过instanceof判断obj对象的真实数据类型是否是后边指定类型
	 * 如果进来了，说明obj的类型是指定的类型，直接进行强制类型转换
	 **/
...
//			prarms.put("members", members);
	...
	public static String gettokens() {
		...
		try {
			...
			br3.close();
			input3.close();
			com.alibaba.fastjson.JSONObject jsonObject3 = com.alibaba.fastjson.JSONObject.parseObject(str3);
