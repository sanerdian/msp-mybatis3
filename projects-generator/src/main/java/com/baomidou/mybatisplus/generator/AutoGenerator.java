...
public class AutoGenerator {
    ...
    public void execute() {
        ...
        // 初始化配置
        if (null == config) {
            config = new ConfigBuilder(packageInfo, dataSource, strategy, template, globalConfig, esCommonService);
    ...
    public ConfigBuilder getConfig() {
        return new ConfigBuilder(packageInfo, dataSource, strategy, template, globalConfig, esCommonService);//.getTableInfoList();
    }
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (config.getStrategyConfig().isEntityBooleanColumnRemoveIsPrefix()) {
                for (TableField field : tableInfo.getFields()) {
                    if (field.getPropertyType()!=null && field.getPropertyType().equalsIgnoreCase("boolean")) {
