package com.jnetdata.msp.zsk.keyword_tag.model;
...
@TableName("JMETA_KEYWORD_TAG")
@ApiModel(value = "KeywordTag对象", description = "关键词标签库")
public class KeywordTag extends BaseEntity implements EntityId<Long>  {
    ...
    @ExcelProperty(value = "标题关键词")
    @ApiModelProperty(value = "标题关键词")
    @TableField("TITLEKEYWORDS")
