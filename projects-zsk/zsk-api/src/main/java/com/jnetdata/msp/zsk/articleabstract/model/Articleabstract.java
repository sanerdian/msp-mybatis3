package com.jnetdata.msp.zsk.articleabstract.model;
...
@TableName("JMETA_ARTICLEABSTRACT")
@ApiModel(value = "Articleabstract对象", description = "文章摘要库")
public class Articleabstract extends BaseEntity implements EntityId<Long>  {
    ...
    @TableField("ABSTRACT1")
    private String abstract1;
    @ExcelProperty(value = "摘要关键词")
    @ApiModelProperty(value = "摘要关键词")
    @TableField("ABSTRACTKEYWORDS")
