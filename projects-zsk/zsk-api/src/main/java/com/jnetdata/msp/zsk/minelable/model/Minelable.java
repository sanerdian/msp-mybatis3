package com.jnetdata.msp.zsk.minelable.model;
...
@TableName("JMETA_MINELABLE")
@ApiModel(value = "Minelable对象", description = "用户的标签")
public class Minelable extends BaseEntity implements EntityId<Long>  {
