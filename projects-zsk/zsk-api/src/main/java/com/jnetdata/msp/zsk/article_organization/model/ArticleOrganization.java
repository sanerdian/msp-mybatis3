package com.jnetdata.msp.zsk.article_organization.model;
...
@TableName("JMETA_ARTICLE_ORGANIZATION")
@ApiModel(value = "ArticleOrganization对象", description = "文章机构库")
public class ArticleOrganization extends BaseEntity implements EntityId<Long>  {
