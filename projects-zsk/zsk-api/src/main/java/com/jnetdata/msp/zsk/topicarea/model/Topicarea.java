package com.jnetdata.msp.zsk.topicarea.model;
...
@TableName("JMETA_TOPICAREA")
@ApiModel(value = "Topicarea对象", description = "主题词-地名库")
public class Topicarea extends BaseEntity implements EntityId<Long>  {
