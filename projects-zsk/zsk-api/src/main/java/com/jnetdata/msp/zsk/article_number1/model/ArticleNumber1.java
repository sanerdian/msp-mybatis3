package com.jnetdata.msp.zsk.article_number1.model;
...
@TableName("JMETA_ARTICLE_NUMBER1")
@ApiModel(value = "ArticleNumber1对象", description = "文章文号库")
public class ArticleNumber1 extends BaseEntity implements EntityId<Long>  {
