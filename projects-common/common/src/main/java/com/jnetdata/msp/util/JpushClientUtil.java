...
public class JpushClientUtil {
    ...
    public static void main(String[] args) {
        ...
        int i1 = JpushClientUtil.sendToRegistrationIds(registrationIds,"xxx", "xxx", "xxx", "扩展字段");
     ...
     */
    private final static String APPKER ="3524891ec5ee33e3b9804e47";
    private final static String MASTERSECRET ="ed9e5bc356fe40b5e508287e";
    /**
     * ApnsProduction
