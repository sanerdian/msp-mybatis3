 ...
 * the License.
 */
package com.jnetdata.msp.util.generator;
...
public class ConstVal {
    ...
    public static final String PARENT_POM = "parentpom";
    public static final String POM = "pom";
    public static final String APIPOM = "apipom";
    ...
    public static final String BAT_PATH = "bat_path";
    public static final String PARENT_POM_PATH = "parentpom_path";
    public static final String POM_PATH = "pom_path";
    public static final String APIPOM_PATH = "apipom_path";
    ...
    public static final String POM_SUFFIX = ".xml";

    public static final String TEMPLATE_ENTITY_JAVA = "/templates/entity.java";
    public static final String TEMPLATE_ES_ENTITY_JAVA = "/templates/esentity.java";
    ...
    public static final String TEMPLATE_BAT = "/templates/mpackage.bat";
    public static final String TEMPLATE_PARENT_POM = "/templates/parentPom.xml";
    public static final String TEMPLATE_POM = "/templates/pom.xml";
    public static final String TEMPLATE_API_POM = "/templates/apipom.xml";
    public static final String TEMPLATE_ES_CONTROLLER = "/templates/escontroller.java";
    public static final String TEMPLATE_ES_SERVICE = "/templates/esservice.java";
    public static final String TEMPLATE_ES_SERVICEIMPL = "/templates/esserviceImpl.java";
