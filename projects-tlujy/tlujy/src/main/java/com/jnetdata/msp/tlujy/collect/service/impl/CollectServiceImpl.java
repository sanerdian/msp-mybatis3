package com.jnetdata.msp.tlujy.collect.service.impl;
...
public class CollectServiceImpl extends BaseServiceImpl<CollectMapper, Collect> implements CollectService {
    ...
    @Override
    public PropertyWrapper<Collect> makeSearchWrapper(Map<String, Object> condition) {
        if(condition.get("andOr")!=null) {
            this.andOr = condition.get("andOr").toString();
        }
        PropertyWrapper<Collect> pw = createWrapperUtil(condition)
                                        .eq("id")
                                                            .eq("docchannelid")
                                                            .eq("docstatus")
                                                            .eq("singletempkate")
    ...
    @Override
    public Collect getEntityAndJoinsById(Long id){
        Collect entity = getById(id);
        getJoin(entity, null);
        return entity;
    }

    public void getJoin(Collect entity, Collect vo) {
        if(vo == null) {
            vo = new Collect();
        }
    }
    ...
    @Override
    public void getListJoin(List<Collect> list, Collect vo) {
