package com.jnetdata.msp.tlujy.yjfk_photo.model;
...
@TableName("JMETA_YJFK_PHOTO")
@ApiModel(value="YjfkPhoto对象", description="")
public class YjfkPhoto extends BaseEntity implements EntityId<Long>  {
