package com.jnetdata.msp.tlujy.joinuser.model;
...
@TableName("JMETA_JOINUSER")
@ApiModel(value="Joinuser对象", description="")
public class Joinuser extends BaseEntity implements EntityId<Long>  {
