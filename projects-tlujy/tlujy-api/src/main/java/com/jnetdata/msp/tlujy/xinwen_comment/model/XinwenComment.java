package com.jnetdata.msp.tlujy.xinwen_comment.model;
...
@TableName("JMETA_XINWEN_COMMENT")
@ApiModel(value="XinwenComment对象", description="")
public class XinwenComment extends BaseEntity implements EntityId<Long>  {
