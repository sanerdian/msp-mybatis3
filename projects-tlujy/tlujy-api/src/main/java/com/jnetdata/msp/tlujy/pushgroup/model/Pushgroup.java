package com.jnetdata.msp.tlujy.pushgroup.model;
...
@TableName("JMETA_PUSHGROUP")
@ApiModel(value="Pushgroup对象", description="")
public class Pushgroup extends BaseEntity implements EntityId<Long>  {
