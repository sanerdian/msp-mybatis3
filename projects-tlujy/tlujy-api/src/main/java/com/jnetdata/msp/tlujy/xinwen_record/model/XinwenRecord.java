package com.jnetdata.msp.tlujy.xinwen_record.model;
...
@TableName("JMETA_XINWEN_RECORD")
@ApiModel(value="XinwenRecord对象", description="")
public class XinwenRecord extends BaseEntity implements EntityId<Long>  {
