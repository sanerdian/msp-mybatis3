package com.jnetdata.msp.tlujy.votetheme.model;
...
@TableName("JMETA_VOTETHEME")
@ApiModel(value="Votetheme对象", description="")
public class Votetheme extends BaseEntity implements EntityId<Long>  {
