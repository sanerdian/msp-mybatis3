package com.jnetdata.msp.tlujy.xinwen_evaluate.model;
...
@TableName("JMETA_XINWEN_EVALUATE")
@ApiModel(value="XinwenEvaluate对象", description="")
public class XinwenEvaluate extends BaseEntity implements EntityId<Long>  {
    ...
    @TableField("EVALUATEOBJECT")
    @JSONField(serializeUsing = ToStringSerializer.class)
    private Long evaluateobject;
    @TableField("IDVALUE")
    @JSONField(serializeUsing = ToStringSerializer.class)
    private Long idvalue;
    @TableField("EVALUATETYPE")
    @JSONField(serializeUsing = ToStringSerializer.class)
