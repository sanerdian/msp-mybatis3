package com.jnetdata.msp.tlujy.answer_user.model;
...
@TableName("JMETA_ANSWER_USER")
@ApiModel(value="AnswerUser对象", description="")
public class AnswerUser extends BaseEntity implements EntityId<Long>  {
    ...
    @TableField("ANSWERCHOOSE")
    @JSONField(serializeUsing = ToStringSerializer.class)
    private Long answerchoose;
