package com.jnetdata.msp.tlujy.yjfk_hhb.model;
...
@TableName("JMETA_YJFK_HHB")
@ApiModel(value="YjfkHhb对象", description="")
public class YjfkHhb extends BaseEntity implements EntityId<Long>  {
