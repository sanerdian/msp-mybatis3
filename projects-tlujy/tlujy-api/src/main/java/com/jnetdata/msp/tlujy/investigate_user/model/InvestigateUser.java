package com.jnetdata.msp.tlujy.investigate_user.model;
...
@TableName("JMETA_INVESTIGATE_USER")
@ApiModel(value="InvestigateUser对象", description="")
public class InvestigateUser extends BaseEntity implements EntityId<Long>  {
    ...
    @TableField("RECOVERSTATUS")
    private Integer recoverstatus;
    @TableField("ANSWEREDNUM")
    private Integer answerednum;
    @TableField("SECONDREST")
    @JSONField(serializeUsing = ToStringSerializer.class)
    private Long secondrest;
    @TableField("ISPUSH")
