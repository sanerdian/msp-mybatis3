package com.jnetdata.msp.tlujy.xinwen_user.model;
...
@TableName("JMETA_XINWEN_USER")
@ApiModel(value="XinwenUser对象", description="")
public class XinwenUser extends BaseEntity implements EntityId<Long>  {
