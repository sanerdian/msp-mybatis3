package com.jnetdata.msp.tlujy.integral.model;
...
@TableName("JMETA_INTEGRAL")
@ApiModel(value="Integral对象", description="")
public class Integral extends BaseEntity implements EntityId<Long>  {
