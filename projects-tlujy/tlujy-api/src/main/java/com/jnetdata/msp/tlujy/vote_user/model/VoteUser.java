package com.jnetdata.msp.tlujy.vote_user.model;
...
@TableName("JMETA_VOTE_USER")
@ApiModel(value="VoteUser对象", description="")
public class VoteUser extends BaseEntity implements EntityId<Long>  {
