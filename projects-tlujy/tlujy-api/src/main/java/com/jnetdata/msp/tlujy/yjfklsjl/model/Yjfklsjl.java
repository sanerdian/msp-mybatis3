package com.jnetdata.msp.tlujy.yjfklsjl.model;
...
@TableName("jmeta_yjfklsjl")
@ApiModel(value="Yjfklsjl对象", description="")
public class Yjfklsjl extends BaseEntity implements EntityId<Long>  {
