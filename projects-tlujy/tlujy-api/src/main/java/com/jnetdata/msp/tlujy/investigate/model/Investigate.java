package com.jnetdata.msp.tlujy.investigate.model;
...
@TableName("JMETA_INVESTIGATE")
@ApiModel(value="Investigate对象", description="")
public class Investigate extends BaseEntity implements EntityId<Long>  {
    ...
    @TableField("SHOWRESULTTYPE")
    @JSONField(serializeUsing = ToStringSerializer.class)
    private Long showresulttype;
    @TableField("HSSTARTDATE")
    @JSONField(format = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date hsstartdate;
    @TableField("HSENDDATE")
    @JSONField(format = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date hsenddate;
    @TableField("REMARKS")
    ...
    @TableField("TIMELIMITFLAG")
    private Integer timelimitflag;
    @TableField("TIMELIMITSECOND")
    @JSONField(serializeUsing = ToStringSerializer.class)
    private Long timelimitsecond;
    @TableField("ISALLOWEDLEAVEMIDWAY")
    private Integer isallowedleavemidway;
    @TableField("PAGETYPE")
