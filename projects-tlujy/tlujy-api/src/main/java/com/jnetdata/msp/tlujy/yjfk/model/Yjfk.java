package com.jnetdata.msp.tlujy.yjfk.model;
...
@TableName("JMETA_YJFK")
@ApiModel(value="Yjfk对象", description="")
public class Yjfk extends BaseEntity implements EntityId<Long>  {
