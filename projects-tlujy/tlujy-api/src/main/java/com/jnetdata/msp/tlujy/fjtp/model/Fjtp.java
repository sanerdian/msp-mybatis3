package com.jnetdata.msp.tlujy.fjtp.model;
...
@TableName("JMETA_FJTP")
@ApiModel(value="Fjtp对象", description="")
public class Fjtp extends BaseEntity implements EntityId<Long>  {
