package com.jnetdata.msp.tlujy.topic.model;
...
@TableName("JMETA_TOPIC")
@ApiModel(value="Topic对象", description="")
public class Topic extends BaseEntity implements EntityId<Long>  {
    ...
    @TableField("SELECTMIN")
    @JSONField(serializeUsing = ToStringSerializer.class)
    private Long selectmin;
    @TableField("SELECTMAX")
    @JSONField(serializeUsing = ToStringSerializer.class)
