package com.jnetdata.msp.tlujy.vote_content.model;
...
@TableName("JMETA_VOTE_CONTENT")
@ApiModel(value="VoteContent对象", description="")
public class VoteContent extends BaseEntity implements EntityId<Long>  {
